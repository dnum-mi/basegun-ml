...
class TestTypo:
    ...
    def test_autre_pistolet(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/autrepistolet.jpg'))
        assert pred[0] == "autre_pistolet"

    def test_epaule_ancien(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/epaule_ancien.jpg'))
        assert pred[0] == "epaule_mecanisme_ancien"   
    
    def test_levier_sous_garde(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/levier_sous_garde.jpg'))
        assert pred[0] == "epaule_a_levier_sous_garde"
    
    def test_pistolet_ancien(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/pistolet_ancien.jpg'))
        assert pred[0] == "pistolet_mecanisme_ancien"

    def test_pistolet_semi_auto(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/pistolet_semi_auto.jpg'))
    ...
    def test_semi_auto_chasse(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/semi_auto_chasse.jpg'))
        assert pred[0] == "epaule_semi_auto_style_chasse"

    def test_semi_auto_mil20(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/semi_auto_mil_20.jpg'))
        assert pred[0] == "epaule_semi_auto_style_militaire_milieu_20e"
    
    def test_semi_auto_mil_autre(self):
        pred=get_typology(to_bytes(this_dir + '/tests_images/test_typo/semi_auto_mil_autre.jpg'))
